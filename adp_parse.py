...
def parse_md(seed,equ_timesteps,ureg):
    # load md file
    ...
    # create MD object
    md = adp_obj.MD(len(idxs),atoms,positions,velocities,ureg)

    return md

def parse_cell(seed,ureg):
    ...
    cell = adp_obj.Cell(lattice_block,positions_block,ureg)
